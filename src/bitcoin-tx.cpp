...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s megabitcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  megabitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded megabitcoin transaction") + "\n" +
              "  megabitcoin-tx [options] -create [commands]   " + _("Create hex-encoded megabitcoin transaction") + "\n" +
              "\n";
